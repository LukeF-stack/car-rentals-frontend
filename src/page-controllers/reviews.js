    ...
    .then((reviews) => {
      ...
      if (reviews.length > 0) {
        reviews.forEach((review) => {
          ...
          let reviewResult = document.querySelector(
            `#review-${reviewObj.data._id}`
          );
          ...
          if (User.id == reviewObj.data.User_id) {
            ...
            deleteBtn.addEventListener("click", () => {
              ...
              fetch(
                `https://car-rentals-backend-api.herokuapp.com/api/reviews/${reviewObj.data._id}`,
                { method: "DELETE" }
              )
                .then((res) => {
                  ...
                  if (res.status !== 200) {
                    ...
                    // else (success) show success notification & go back to selected car page
