    ...
    Car.getByIds(id)
        .then(car => {
            ...
            car.forEach(car => {
                ...
                const selectedCarTemplate = document.querySelector('#template-selectedCar-entry').innerHTML;
                ...
                document.querySelector('.book-btn').addEventListener('click', () => {
                    ...
                    if (Auth.authenticated == true && (car.available == true)){
                        ...
                        fetch(`http://localhost:8081/api/cars/${car._id}`, {
                            method: 'PUT',
                        ...
                        .then(res => {
                            ...
                            } else { // else (success) show success Notification and set car.available to false to prevent double booking wihtout page reload
                    ...
                    } else { //else (car isn't available) show message 'already booked'
